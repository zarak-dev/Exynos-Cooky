...
export const LoginForm: React.FC<LoginFormProps> = ({ onSwitchToSignup }) => {
  ...
  const handleOAuthApple = () => {
    message.info("Apple Sign-In is configured via Supabase OAuth (requires an Apple Developer Account).");
  };
  ...
  return (
    <FormContainer>
      ...
      <SocialButtonGroup>
        <SocialButton type="button" onClick={handleOAuthApple}>
        ...
        <SocialButton type="button" onClick={handleOAuthGoogle}>
